 ...
 * @author wagner
 */
public class ConsultaVendedor extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            itens = connection.ReturnSQLCollectionVendedor("select CODIGO, NOME from FUNCIONARIO WHERE (UPPER (NOME))"
        ...
        saida.println("<vendedores>");
        for (int i = 0; i < itens.size(); i++) {
            saida.println("\t<vendedor>");
